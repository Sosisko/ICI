...
export const metadata = {
  title: "Водогрейные котлы TNX / TNX EN - ICI Caldaie",
  description: "Каталог котлов ICI Caldaie, водогрейные котлы TNX / TNX EN",
  keywords: "ICI Caldaie, котлы, водогрейные котлы TNX / TNX EN",
};
