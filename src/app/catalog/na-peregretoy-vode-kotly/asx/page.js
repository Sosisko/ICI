...
export const metadata = {
  title: "Котлы на перегретой воде ASX - ICI Caldaie",
  description: "Каталог котлов ICI Caldaie, котлы на перегретой воде ASX",
  keywords: "ICI Caldaie, котлы, котлы на перегретой воде ASX",
}
