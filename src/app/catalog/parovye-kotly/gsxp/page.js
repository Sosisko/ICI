...
const rex = () => {
  return (
    <>
      <Head>
        <title>Паровые котлы GSX P - ICI Caldaie</title>
        <meta
          name="description"
          content="Каталог котлов ICI Caldaie, паровые котлы GSX P"
        />
        <meta name="keywords" content="ICI Caldaie, котлы, паровые котлы GSX P" />
        <meta property="og:title" content="Паровые котлы GSX P - ICI Caldaie" />
      </Head>
      ...
      <section className={s.description}>
        <div className="container">
          ...
          <div className={s.descriptionBlock}>
            ...
            <img
              src="/images/catalog/parovye-kotly/gsxp/table.jpg"
              alt="Паровые котлы GSX P"
            />
          </div>
          <div className={s.descriptionBlock}>
