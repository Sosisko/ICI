...
const rex = () => {
  return (
    <>
      <Head>
        <title>Паровые котлы GX - ICI Caldaie</title>
        <meta
          name="description"
          content="Каталог котлов ICI Caldaie, паровые котлы GX"
        />
        <meta name="keywords" content="ICI Caldaie, котлы, паровые котлы GX" />
        <meta property="og:title" content="Паровые котлы GX - ICI Caldaie" />
      </Head>
      ...
      <section className={s.description}>
        <div className="container">
          ...
          <div className={s.descriptionBlock}>
            ...
            <img
              src="/images/catalog/parovye-kotly/gx/table.jpg"
              alt="Паровые котлы GX"
            />
          </div>
          <div className={s.descriptionBlock}>
