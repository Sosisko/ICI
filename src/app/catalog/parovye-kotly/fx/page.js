...
export const metadata = {
  title: "Паровые котлы FX / FX DUAL - ICI Caldaie",
  description: "Каталог котлов ICI Caldaie, паровые котлы FX / FX DUAL",
  keywords: "ICI Caldaie, котлы, паровые котлы FX / FX DUAL",
}
