...
const rex = () => {
  return (
    <>
      <Head>
        <title>Паровые котлы SIXEN - ICI Caldaie</title>
        <meta
          name="description"
          content="Каталог котлов ICI Caldaie, паровые котлы SIXEN"
        />
        <meta
          name="keywords"
          content="ICI Caldaie, котлы, паровые котлы SIXEN"
        />
        <meta property="og:title" content="Паровые котлы SIXEN - ICI Caldaie" />
      </Head>
