...
const rex = () => {
  return (
    <>
      <Head>
        <title>Паровые котлы GX S - ICI Caldaie</title>
        <meta
          name="description"
          content="Каталог котлов ICI Caldaie, паровые котлы GX S"
        />
        <meta
          name="keywords"
          content="ICI Caldaie, котлы, паровые котлы GX S"
        />
        <meta property="og:title" content="Паровые котлы GX S - ICI Caldaie" />
      </Head>
