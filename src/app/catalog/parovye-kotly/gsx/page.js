...
const rex = () => {
  return (
    <>
      <Head>
        <title>Паровые котлы GSX - ICI Caldaie</title>
        <meta
          name="description"
          content="Каталог котлов ICI Caldaie, паровые котлы GSX"
        />
        <meta name="keywords" content="ICI Caldaie, котлы, паровые котлы GSX" />
        <meta property="og:title" content="Паровые котлы GSX - ICI Caldaie" />
      </Head>
